...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
        self.viewController = [[HFAViewController alloc] initWithNibName:@"HFAViewController_iPhone" bundle:nil];
    } else {
        self.viewController = [[HFAViewController alloc] initWithNibName:@"HFAViewController_iPad" bundle:nil];
    }
